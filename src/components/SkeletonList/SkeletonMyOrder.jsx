...
const SkeletonCard = () => (
  <div className="bg-zinc-900/80 cursor-pointer grid gap-1 h-56 p-4 rounded-2xl shadow-lg border border-yellow-500">
...
const SkeletonMyOrder = ({ number = 3 }) => (
  <div className="grid">
...
export default SkeletonMyOrder;
